...
if (!empty($_POST['signupSubmit'])) 
{
	...
	if($username_check && $email_check && $password_check && strlen(trim($first_name))>0) 
	{
    $uid=$userClass->userRegistration($username,$password,$email,$first_name, $last_name);
    if($uid)
    {
    	$url=BASE_URL.'user/home.php';
    	header("Location: $url");
